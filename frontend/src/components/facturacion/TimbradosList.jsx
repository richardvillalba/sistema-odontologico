                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-surface-raised/50 border-b border-border">
                                ...
                                <th className="px-8 py-5 text-[10px] font-black text-text-secondary uppercase tracking-widest">Recibo Actual</th>
                            ...
                            {timbrados.length > 0 ? (
                                timbrados.map((timbrado) => (
                                    <tr key={timbrado.timbrado_id} className="hover:bg-surface-raised/30 transition-colors group">
                                        ...
                                        <td className="px-8 py-6">
                                            <span className="bg-secondary/5 text-secondary px-4 py-1.5 rounded-full text-[11px] font-black font-mono border-2 border-secondary/10">
                                                {(timbrado.numero_recibo_actual ?? 0).toString().padStart(7, '0')}
                                            </span>
                                        </td>
                                        <td className="px-8 py-6">
